...
public class WrapperBluetooth extends AbstractWrapper {
    ...
    public WrapperBluetooth(boolean v, Context context, boolean secure, final short nbThreads, ActiveConnections activeConnections, final ListenerAodv listenerAodv,
